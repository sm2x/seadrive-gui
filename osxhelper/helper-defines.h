...
#define HelperMakeError(CODE, MSG, ...) [NSError errorWithDomain:@"teamdrive" code:CODE userInfo:@{NSLocalizedDescriptionKey:[NSString stringWithFormat:MSG, ##__VA_ARGS__], NSLocalizedRecoveryOptionsErrorKey: @[@"OK"]}]
